...
var builtinTemplates = []appTemplate{
	...
	{ID: "kafka", Name: "Kafka", Description: "Distributed event streaming platform (KRaft mode)", Category: "messaging", Icon: "📨", Image: "bitnami/kafka", Tag: "3.7", Port: 9092, ExtraPorts: []extraPort{{Name: "controller", Port: 9093}}, EnvVars: map[string]string{"KAFKA_CFG_NODE_ID": "0", "KAFKA_CFG_PROCESS_ROLES": "controller,broker", "KAFKA_CFG_CONTROLLER_QUORUM_VOTERS": "0@localhost:9093", "KAFKA_CFG_LISTENERS": "PLAINTEXT://:9092,CONTROLLER://:9093", "KAFKA_CFG_LISTENER_SECURITY_PROTOCOL_MAP": "CONTROLLER:PLAINTEXT,PLAINTEXT:PLAINTEXT", "KAFKA_CFG_CONTROLLER_LISTENER_NAMES": "CONTROLLER"}, DataPath: "/bitnami/kafka"},
}
