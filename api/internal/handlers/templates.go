...
var builtinTemplates = []appTemplate{
	...
	{ID: "kafka", Name: "Kafka", Description: "Distributed event streaming platform (KRaft mode)", Category: "messaging", Icon: "📨", Image: "apache/kafka", Tag: "latest", Port: 9092, ExtraPorts: []extraPort{{Name: "controller", Port: 9093}}, DataPath: "/tmp/kraft-combined-logs"},
}
