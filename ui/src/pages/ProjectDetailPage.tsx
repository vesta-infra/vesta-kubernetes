      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 space-y-6">
          ...
          <section>
            ...
            {showCreateApp && (
              /* The card and heading live here rather than in the component: on the Apps
                 page the form shares a card with the project selector above it, so owning
                 its own wrapper would nest one card inside another. */
              <div className="card p-5 space-y-4 animate-slide-up mb-4">
